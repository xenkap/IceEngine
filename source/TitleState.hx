...
class TitleState extends MusicBeatState
{
	...
	var easterEggKeys:Array<String> = [
		'SHADOW', 'RIVER', 'SHUBS', 'BBPANZU', 'AMONG'
	];
	...
	override public function create():Void
	{
		...
		if(!closedState) {
			...
			http.onData = function (data:String)
			{
				...
				var curVersion:String = MainMenuState.iceEngineVersion.trim();
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('titlebg')); //WHY DOES THIS DUMB FUCKING THING NOT WORK A@rwfiohweisfljfgdwjgdsihosdhgi //it make me wanna cry so much aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
