...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [
			// Name - (Icon name - Description - Link - BG Color) OR (Mod Directory)
			['Ice Engine Team', 'ice'],
			[
				'Ran',
				'ran',
				'Main Programmer of Ice Engine',
				'https://www.youtube.com/c/kaipkai/',
				'AFFF6B'
			],
			[
				'EyeDaleHim',
				'eye',
				'Programmer of Ice Engine\n\n(To be honest, he deserves "Main Programmer" more than me...)',
				'',
				'AFFF6B'
			...
			[
				...
				'windows',
				'Programmer of Ice Engine',
				'https://github.com/bot-beep-boop',
				'FFEC6D'
			],
			...
			[
				...
				'https://gamejolt.com/@chebtheidk',
				'53E52C'
			],
			['if mationsYT', 'mations', 'Help on Note Combo sprite bugfixing', '', '53E52C'],
			[
				'JohnnyWereThere',
				'tank',
				'Week 7 Note Splash Offsets !!\ncock joke',
				'https://www.youtube.com/channel/UCnIv3iNRB4vehgx21IgMN-Q',
				'F6B604'
			],
			[''],
			...
			[''],
			['Former Psych Engine Members', 'psych'],
			[
				'bb-panzu',
				'bb-panzu',
			...
			[''],
			['Psych Engine Contributors', 'psych/extra'],
			[
				'iFlicky',
				'iflicky',
			...
			[
				'FNF Mechanics Mod',
				'ice/eye',
				"Check out EyeDaleHim's mechanics mod!",
				'https://gamebanana.com/mods/396626',
				'FFFF66'
			],
			[
				'Chillsides',
				'ice/ran',
				"Check out our FNF remix mod!",
				'https://gamebanana.com/mods/301302',
				'FFFF66'
			]
		];
		...
		for (i in 0...creditsStuff.length)
		{
			...
			if (isSelectable)
			{
				...
				icon.setGraphicSize(Std.int(130));
