...
class FlxGame extends Sprite
{
    ...
    public static var drawMS:Float = 0;
    public static var updateMS:Float = 0;
	...
	function update():Void
	{
        ...
        updateMS = (Lib.getTimer() - firstUpdate);
	}
