...
class VisualsUISubState extends BaseOptionsMenu
{
	...
	public function new()
	{
		...
		// var option:Option = new Option('Mic\'d Up Icons ', "If checked, uses Mic'd Up's redrawn icons.", 'iconVer', 'bool', false);
		// addOption(option);
		...
		var option:Option = new Option('Pause Screen Song:', "What song do you prefer for the Pause Screen?", 'pauseMusic', 'string', 'Breakfast',
