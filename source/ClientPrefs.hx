...
class ClientPrefs
{
	...
	public static var iconVer:Bool = false;
	...
	public static var comboOffset:Array<Int> = [557, -264, 617, -235, 557, -189, 100, 100];
	...
	{
		// if(FlxG.save.data.noteScroll != null) {
		// 	noteScroll = FlxG.save.data.noteScroll;
		// }
