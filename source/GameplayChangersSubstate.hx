...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Health Drain Multiplier', 'healthdrain', 'float', 0.5);
		option.scrollSpeed = 2.5;
		option.minValue = 0;
		option.maxValue = 5;
		option.changeValue = 0.1;
		...
		var option:GameplayOption = new GameplayOption('Loop Song (Freeplay)', 'loops', 'bool', false);
		optionsArray.push(option);
		...
		var option:GameplayOption = new GameplayOption('Play as Opponent', 'foeplay', 'bool', false);
		optionsArray.push(option);
	}
